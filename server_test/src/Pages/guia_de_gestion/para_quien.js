...
class Metodologia extends Component {
  ...
  main = (element) => {
    ...
    *******************************/
    ...
    const x_triangle = getPositionMenuSelected(2, width, height);
    ...
    *******************************/
    breadCrumbGuia(svg, 2, width, height);
    /******************************
  ...
  var textSetRectCol = [
    {
      enc: '',
      desc: 'Para personas involucradas de manera directa o indirecta en la gestión de la cadena de suministro, ya sea como mandantes y/o proveedores.<br/><br/>'+
      'Para quienes toman decisiones a nivel gerencial.<br/><br/>'+
      'Para todas las áreas involucradas en la cadena de suministro: Compras, Administración, Finanzas, Soporte, Tecnología, Cumplimiento, Riesgo y Control Interno.',
    },
  ]
  ...
  svg.append('image')
    .attr('id', 'img')
    .attr("xlink:href", window.location.origin + '/img/para-quien.png')
    .attr("x", rp(1224, 'x', width, height))
    .attr("y", rp(400, 'x', width, height))
    .attr("width", rp(600, 'x', width, height))
    .attr('opacity', 1)
