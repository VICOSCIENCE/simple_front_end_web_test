...
class Metodologia extends Component {
  ...
  main = (element) => {
    ...
    *******************************/
    ...
    const x_triangle = getPositionMenuSelected(4, width, height);
    ...
    *******************************/
    breadCrumbGuia(svg, 4, width, height);
    /******************************
    ...
    *******************************/
    ...
    valuesSetRectCol['wCont'] = rp(1000, 'x', width, height);
  ...
  var textSetRectCol = [
    {
      enc: '',
      desc: 'En nuestro país la gestión sostenible de la cadena de suministro ha sido insuficiente, '+
      'representando una de las materias con menor avance en sostenibilidad al interior de las organizaciones. '+
      'Esto se expresa en la existencia de una significativa brecha en la relación entre las grandes empresas y las pymes, '+
      'lo cual se refleja en escasas instancias de encuentro, comunicación y reflexión que promuevan las prácticas virtuosas '+
      'entre las empresas en torno al aprovisionamiento responsable.',
    },
  ]
  ...
  svg.append('image')
    .attr('id', 'img')
    .attr("xlink:href", window.location.origin )
