...
class Etapas extends Component {
  ...
  main = (element) => {
    ...
    ****************************************/
    ...
    var fontSize_textArco = relPos(24, width) + 'px';
    var cantidadMaximaDeCaracteres = 25;
    var ultimoEspacio = 0;
    var filaDetalle;
    var arrFilaDetalle;
    var filaRecortada;
    ...
    /*
    var segmenFila = new Array(textFila.length);
    for (let i = 0; i < segmenFila.length; i++) {
      segmenFila[i] = new Array();
    }
    /** */
    ...
    *****************************************/
    ...
    var tituloLeyenda = 'Competencias';
    //var textRol = ['Mandante', 'Compartidas', 'Proveedor'];
    //const colorRol = ['#9E6F9E', '#D9E021', '#B3BABD']; // mandante, compartido, proveedor,
    ...
    *********************************************/
    ...
    var mueveSegmento = relPos(145, width);       //<======================
    ...
    var ajuste = (mueveSegmento_ref - mueveSegmento + relPos(20, width)) * -1;
