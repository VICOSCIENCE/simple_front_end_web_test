...
class BuenasPracticas extends Component {
  ...
  main = (element) => {
    ...
    *****************************************/
    ...
    const practicasLink = [];
    practicasLink[5] = 'buenas_practicas/1_cumplimiento_legalidad';
    practicasLink[4] = 'buenas_practicas/2_compromisos_y_cumplimientos';
    practicasLink[3] = 'buenas_practicas/3_peticion_o_adscripcion_internacional';
    practicasLink[2] = 'buenas_practicas/4_mecanismos_de_aseguramiento';
    practicasLink[1] = 'buenas_practicas/5_metodologia_de_trabajo';
    practicasLink[0] = 'buenas_practicas/6_metodos_de_trabajo_colaboratico';
    ...
    ******************************************************/
    ...
    svg.append("foreignObject")
      ...
      .attr('opacity', 0)
      .html(function (d) {
        return '<div style="' + style_text + '"><p align="justify"> . </p></div>'
      });
    svg.append("circle")
      .attr("id", 'circleNivel')
      .attr("cx", x_text)
        ...
        svgClicklAreaEspiral.append("path")
          ...
          .on('mouseover', function () {
            ...
            d3.select('#textoAgrandado')
              .html(function (d) {
                return '<div style="' + style_text + '"><p align="justify"> ' + textosPracticas[p][s] + ' </p></div>';
              })
              .transition()
              .duration(100)
              .attr('opacity', 1);
